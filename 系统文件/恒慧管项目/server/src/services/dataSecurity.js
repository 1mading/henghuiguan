...
const API_CATALOG = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/api/external/projects/:id/registers', auth: 'apiKey', risk: 'medium', desc: '读取项目登记册' },
      { method: 'PUT', path: '/api/external/projects/:id/registers/:registerKey', auth: 'apiKey', risk: 'high', desc: '替换项目登记册' },
      { method: 'PATCH', path: '/api/external/projects/:id/document-slots', auth: 'apiKey', risk: 'high', desc: '标注项目文档槽' },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'GET', path: '/api/workbuddy/projects/:id/registers', auth: 'apiKey', risk: 'medium', desc: '项目登记册' },
  ...
  },
  {
    ...
    endpoints: [
      ...
      { method: 'POST', path: '/api/files/link-dingtalk-doc', auth: 'jwt', risk: 'medium', desc: '关联钉钉文档或闪记链接' },
      { method: 'GET', path: '/api/files/wiki/workspaces', auth: 'jwt', risk: 'low', desc: '当前用户知识库列表' },
